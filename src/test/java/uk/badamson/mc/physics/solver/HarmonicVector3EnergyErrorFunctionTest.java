...
public class HarmonicVector3EnergyErrorFunctionTest {
    ...
    public static void assertInvariants(HarmonicVector3EnergyErrorFunction f) {
        ObjectTest.assertInvariants(f);// inherited
        EnergyErrorFunctionTest.assertInvariants(f);// inherited
    }

    public static void assertInvariants(HarmonicVector3EnergyErrorFunction f1, HarmonicVector3EnergyErrorFunction f2) {
